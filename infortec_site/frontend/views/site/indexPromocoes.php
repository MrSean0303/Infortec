...
<div class="site-index">
    ...
    <ul class="nav nav-tabs">
        <li><a href="<?= Url::toRoute("site/index") ?>">Todos os Produtos</a></li>
        <li class="active"><a href="<?= Url::toRoute("site/promocoes") ?>">Promoções</a></li>
    </ul>
    ...
    <div class="allCards">
        ...
        <?php
        if ($prod == null) {
            echo "<p class=\"alert alert-warning\" role=\"alert\">Não existem produtos em promoção. Desculpe o Incómodo.</p>";
        }
